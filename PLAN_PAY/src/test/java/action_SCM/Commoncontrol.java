...
//		test
		...
		Thread.sleep(500);
		try {
			EIP_Menu.SelectNextIconPaymentTerms1.click();
		} catch (Exception e) {
			Baseclass.toclick(EIP_Menu.SelectNextIconPaymentTerms1);
		}
...
//		 EIP_Menu.AcceptAlert.click();
	...
	public static void SelectBillingToShippingToAuctionRefRFQ() throws Throwable {
		...
		if (EIP_Menu.ShipmentDetailsFromclose.isEnabled()) {
			Thread.sleep(1000);
			EIP_Menu.ShipmentDetailsFromclose.click();
			Thread.sleep(1000);
			EIP_Menu.SelectBillingToShipmentDetails.click();
			...
			//EIP_Menu.SelectBillingToShipmentDetails_clear.click();
			EIP_Menu.SelectBillingToShipmentDetails.click();
		...
		if (EIP_Menu.ShipmentDetailsToclose.isEnabled()) {
			Thread.sleep(1000);
			EIP_Menu.ShipmentDetailsToclose.click();
			Thread.sleep(1000);
			EIP_Menu.SelectShippingToShipmentDetails.click();
...
//js.executeScript("arguments[0].click()", EIP_Menu.RFQOrderExpiryDate);
	...
	public static void AucMatRequestEssentialsAdditionalDetails() throws Throwable {
		 ...
		 * ; EIP_Menu.OrderExpiryDate.click();
		 * 
		 * wait.until(ExpectedConditions.elementToBeClickable(EIP_Menu.
		 * RFQOrderExpiryDate)); //js.executeScript("arguments[0].click()",
		 * EIP_Menu.RFQOrderExpiryDate); EIP_Menu.RFQOrderExpiryDate.click();
		 */
...
//		EIP_Menu.AcceptAlert.click();
		...
		try {
			...
			System.out.println("Didn't Show Alert ");
		}
		Thread.sleep(1000);
		try {
			EIP_Menu.SelectNextIconPaymentTerms.click();
		} catch (Exception e) {
			Baseclass.toclick(EIP_Menu.SelectNextIconPaymentTerms);
		}
...
//js.executeScript("arguments[0].click()", EIP_Menu.RFQOrderExpiryDate);
	...
	public static void AttachmentRFQCreation() throws Throwable {
		...
		/*
		 * assertEquals("Attach General Terms & Conditions",
		 * EIP_Menu.AttachGeneralTerms.getText()); System.out.println("Attachment = " +
		 * EIP_Menu.AttachGeneralTerms.getText());
		 * 
...
//js.executeScript("arguments[0].click()", EIP_Menu.TCSave);
		...
		System.out.println("Successfully Verfied");
	}
	...
	public static void AttachmentAuctionCreation() throws Throwable {
		...
		/*
		 * try { EIP_Menu.AuctionAttachGeneralTermsS.click(); } catch(Exception e) {
		 * js.executeScript("arguments[0].click();",
		 * EIP_Menu.AuctionAttachGeneralTermsS); }
		 */
...
//ALL - ALL
	...
	public static void eAuctionAlert() throws Throwable {
		...
		/*
		 * try { EIP_Menu.AcceptAlertR.click(); } catch(Exception e) {

...
public class common_controls {
	...
	public static void search_ion() {    	    	
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("Search Icon is enabled");
    ...
    public static void view_icon() {    	    	
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("View Icon is enabled");
    ...
    public static void share_icon() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("Share Icon is enabled");
    ...
    public static void email_icon() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("Email Icon is enabled");
    ...
    public static void create_icon() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("Create Icon is enabled");
    ...
    public static void reject_icon() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("Reject Icon is enabled");
    ...
    public static void approve_icon() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("Approve Icon is enabled");
    ...
    public static void all_tab() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("All Tab is enabled");
    ...
    public static void for_action_tab() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("For Action Tab is enabled");
    ...
    public static void inprogress_tab() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("InProgress Tab is enabled");
    ...
    public static void rejected_tab() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("Reject Tab is enabled");
    ...
    public static void approve_tab() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("Approved Tab is enabled");
    ...
    public static void latest_revision() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("Revision button is enabled");
    ...
    public static void recordsperpage() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("Records Perpage is enabled");
    ...
    public static void excel_download() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("Download Excel is enabled");
    ...
    public static void excel_upload() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("Upload Excel is enabled");
    ...
    public static void expand() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("Expand grid is enabled");
    ...
    public static void last_30days_records() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("Last 30 Days Records is enabled");
    ...
    public static void myDoc() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("My Document is enabled");
    ...
    public static void myOrgDoc() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("My Org Document is enabled");
    ...
    public static void myAllDoc() {
    	...
    	assertTrue(status);
    	Reporter.addScenarioLog("All Org Document is enabled");
	...
	public static void template_download() throws InterruptedException {
		...
		//File f = null;
		 ...
		 if (listOfFile.isFile()) {
		    ...
		    //     f = new File(fileName);
		           ...
		           Reporter.addScenarioLog("File has been identified.");
	  ...
	  public static void fileAttachment(String inputFilePath, String fileName, String fileType) throws AWTException, InterruptedException {
	    ...
	    Reporter.addScenarioLog("File Attachment Successfull");
	    ...
	    public static void loginForVerification(String userName, String password) throws InterruptedException, AWTException{
	    	...
	    	Reporter.addScenarioLog("Login Success & landed to home page dashboard");
	    ...
	    public static void mailVerification(String messageNumber) throws InterruptedException, AWTException
	    {
				...
				Reporter.addScenarioLog("Message Recevied successfully");
	    ...
	    public static void sharedocumentVerification(String docnumber) throws InterruptedException, AWTException
	    {
				...
				Reporter.addScenarioLog("Document Recevied successfully");
	    ...
	    public static void revision(String documentnumber) throws InterruptedException {
	    	...
	    	if(size>1) {
	    		try {
		    		...
		    		Reporter.addScenarioLog("Document has revision = " + size + "= Revisions Found" );	
	    		}
	    		catch (Exception e) {
	    			System.out.println("Document has revision : " + size + " = Revisions Found" );
		    		Reporter.addScenarioLog("Document has revision : " + size + " = Revisions Found" );	
	    		...
	    		Reporter.addScenarioLog("No revision found");
	    	}
	    }
	    ...
	    public static void lastPage() throws InterruptedException {
	    	...
	    	if(lastpagestatus==true) {
	    		...
	    		Reporter.addScenarioLog("Navigated to last page");	    		
	    	}
	    }
	    ...
	    public static void firstPage() {
	    	...
	    	Reporter.addScenarioLog("Navigated to first page");
	    	}
	    }
	    ...
	    public static void nextPage() {
	    	...
	    	Reporter.addScenarioLog("Navigated to next page");
	    	}
	    }
	    ...
	    public static void previousPage(){
	    	...
	    	Reporter.addScenarioLog("Navigated to previous page");
	    	}
	    }
	    ...
	    public static void filterSearch(String document_No) throws InterruptedException {
			...
			System.out.println("Found Ressults = " + foundresults);
					if (document_No.equals(foundresults)) {						
						...
						Reporter.addScenarioLog("Filter Result Found.");
						System.out.println("File Attached in = "+document_No);
			    }
					else {
						
						Reporter.addScenarioLog("Filter Result Not Found.");
					}
	    	}
	    ...
	    public static void Search(String document_No, String documentType) throws InterruptedException {	
	    	...
	    	List<WebElement> searchtype = CommonControlObject.searchType;

package com.report.cucumber.listener;
...
public enum ExtentProperties {
    ...
    String userDir =System.getProperty("user.dir"+"src//reports//cucumber-reports//reports");
...

    {
        ...
        timeStamp.replace(":","").replace(".","_") + File.separator + "Executionreport.html"; 

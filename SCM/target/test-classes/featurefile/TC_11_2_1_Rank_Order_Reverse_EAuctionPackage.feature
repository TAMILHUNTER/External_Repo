@eAuctionPackageRankOrderReversePartOne
...
@eAuctionPackageRankOrderReverseRateDiscoveryBQ
  Scenario: eAuction Rank Order Reverse BQ
...
@eAuctionPackageRankOrderReverseRateDiscoveryBaseRateApplicableBQ
  Scenario: eAuction Rank Order Reverse Base Rate Applicable BQ
    Then RFQ Bidders Quote Login
    Then Select Show Advance Search
    Then Enter Domestic Job Auction No from DB
    #Then Select Buyer in Bidders Quote as <Buyer>
...
@eAuctionPackageRankOrderReverseRateDiscoveryMultiVendorandMultiMaterialPostAllBidsVendorABQ
  Scenario: eAuction Package Rank Order Reverse Rate Discovery Multi Vendor and Multi Material Post All Bids Vendor A BQ
    Then RFQ Bidders Quote Login
    Then Select Show Advance Search
    Then Enter Domestic Job Auction No from DB
    #Then Select Buyer in Bidders Quote as <Buyer>
...
@eAuctionPackageRankOrderReverseRateDiscoveryMultiVendorandMultiMaterialPostAllBidsVendorBBQ
  Scenario: eAuction Package Rank Order Reverse Rate Discovery Multi Vendor and Multi Material Post All Bids Vendor B BQ
...
@eAuctionPackageRankOrderReverseRateDiscoveryMultiVendorandMultiMaterialPostAllBidsVendorCBQ
  Scenario: eAuction Package Rank Order Reverse Rate Discovery Multi Vendor and Multi Material Post All Bids Vendor C BQ
...
@eAuctionPackageRankOrderReverseRateDiscoveryMultiVendorandMultiMaterialPostAllBidsVendorDBQ
  Scenario: eAuction Package Rank Order Reverse Rate Discovery Multi Vendor and Multi Material Post All Bids Vendor D BQ
...
@eAuctionPackageRankOrderReverseRateDiscoveryMultiVendorandMultiMaterialPostAllBidsVendorABBQ
  Scenario: eAuction Package Rank Order Reverse Rate Discovery Multi Vendor and Multi Material Post All Bids B BQ
    Then RFQ Bidders Quote Vendor THOMPSONENG Login
    Then Select Show Advance Search
    Then Enter Domestic Job Auction No from DB
    #Then Select Buyer in Bidders Quote as <Buyer>

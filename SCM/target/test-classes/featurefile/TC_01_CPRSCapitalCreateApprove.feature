...
Feature: Verify CPRS Creation for Vehicles and Plant Machinery , Approval and Asset Request Page
  ...
  Scenario Outline: Capital Purchase Request Creation
  ...
  Scenario Outline: CPRS Level Three Approval Resource Allocation
    Then Click on Other User
    Then Enter the Username from db <documentType>
    Then Enter the Password
    Then Click on Login
  ...
  Scenario Outline: CPRS Fourth Level Approval Quantity Allocation
    Then Click on Other User
    Then Enter the Username from db <documentType>
    Then Enter the Password
    Then Click on Login
  ...
  Scenario Outline: CPRS Eighth Level Approval Technical Evaluation
    ...
    Examples: 
      ...
      | CPRS         |                         63 |                         454 |       10 | Request Accepted |

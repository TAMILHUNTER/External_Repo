@RFQRateDiscoveryMaterialRegiEndToEnd
Feature: Verify the RFQ Creation

  Background: 
    Given Go to Test Environment

  Scenario: Domestic Job Material Rate Discovery RFQ Create Verification
  ...
  Scenario: Domestic Job RD RFQ BQ
  ...
  Scenario: Domestic Job Material Rate Discovery RFQ Create Using Other cost Percentage Verification
    Then Click on Other User
    Then Enter EIP QA Username
    Then Enter the Password
    Then Click on Login
  ...
  Scenario: Domestic Job RD RFQ Other cost Percentage BQ
    Then RFQ Bidders Quote Login
    Then Select Show Advance Search
    Then Enter Domestic Job RFQ No from DB
    Then Select Search icon in Bidders Quote
    ...
    Then Select Bill From in Shipment Details
    Then Select GST Register No in Shipment Details
    Then Select Other Cost in RFQ BQ Page
    Then Select Category Other Cost in RFQ BQ Page
    Then Select Category From the list Other Cost in RFQ BQ Page
    Then Select Other Cost Option in RFQ BQ Page
    Then Enter Unit Value Other Cost in RFQ BQ Page
    Then Enter Remarks Other Cost in RFQ BQ Page
    Then Select Post Other Cost in RFQ BQ Page
    # Then Page Down RFQ Bidders Quote Shipment Details
    Then Select Save icon in Shipment Details BQ
    Then Accept Alert
    Then Click Trade Details in Techno Commercials
  ...
  Scenario: Material TCC Page Other cost Percentage
    Then Request For Quote Login for TCC
    Then Select Filter icon
    And Enter Domestic Job RFQ No from DB TCC
    Then Mouseover in RFQ Numner TCC
    ...
    Scenario: Domestic Job Material Rate Discovery RFQ Create Using Other cost Lumpsum Verification
    Then Click on Other User
    Then Enter EIP QA Username
    Then Enter the Password
    Then Click on Login
  ...
  Scenario: Domestic Job RD RFQ Other cost Lumpsum BQ
    Then RFQ Bidders Quote Login
    Then Select Show Advance Search
    Then Enter Domestic Job RFQ No from DB
    Then Select Search icon in Bidders Quote
    ...
    Then Enter Unit Value Lumpsum Other Cost in RFQ BQ Page
    Then Enter Remarks Other Cost in RFQ BQ Page
    Then Select Post Other Cost in RFQ BQ Page
    # Then Page Down RFQ Bidders Quote Shipment Details
    Then Select Save icon in Shipment Details BQ
  ...
  Scenario: Material TCC Page Other cost Lumpsum
    Then Request For Quote Login for TCC
    Then Select Filter icon
    And Enter Domestic Job RFQ No from DB TCC
    Then Mouseover in RFQ Numner TCC
    ...
    Then Logout
     ...
     Scenario: Domestic Job Material Rate Discovery RFQ Create Using Multi Vendor and Other cost Lumpsum Verification
    Then Click on Other User
    Then Enter EIP QA Username
    Then Enter the Password
    Then Click on Login
    ...
    Then Verify and Select Attachment in Other Terms Page on RFQ Create
     ...
     Scenario: Domestic Job RD RFQ Other cost Lumpsum Vendor One BQ
    Then RFQ Bidders Quote Login
    Then Select Show Advance Search
    Then Enter Domestic Job RFQ No from DB
    Then Select Search icon in Bidders Quote
    ...
    Then Select Close in Creation Bidders Quote
     ...
     Scenario: Domestic Job RD RFQ Other cost Lumpsum Vendor Second BQ
   Then RFQ Bidders Quote Vendor THOMPSONENG Login
    ...
    Then Select Close in Creation Bidders Quote
     ...
     Scenario: Material TCC Page Other cost Lumpsum Multi VEndor
    Then Request For Quote Login for TCC
    Then Select Filter icon
    And Enter Domestic Job RFQ No from DB TCC
    Then Mouseover in RFQ Numner TCC
    ...
    Then Logout
     ...
     Scenario: Domestic Job Material Rate Discovery RFQ Create Using Multi Vendor and Other cost Percentage Verification
    Then Click on Other User
    Then Enter EIP QA Username
    Then Enter the Password
    Then Click on Login
    ...
    Scenario: Material TCC Page Other cost Percentage Multi Vendor
    Then Request For Quote Login for TCC
    Then Select Filter icon
    And Enter Domestic Job RFQ No from DB TCC
    Then Mouseover in RFQ Numner TCC
    ...
    Then Logout
      ...
      Scenario: Domestic Job Material Rate Discovery RFQ Create Using Multi Vendor and Other cost Percentage and Lumpsum Verification
    Then Click on Other User
    Then Enter EIP QA Username
    Then Enter the Password
    Then Click on Login
   ...
   Then RFQ Bidders Quote Vendor THOMPSONENG Login
    ...
    Scenario: Material TCC Page Other cost Percentage and Lumpsum Multi VEndor
    Then Request For Quote Login for TCC
    Then Select Filter icon
    And Enter Domestic Job RFQ No from DB TCC
    Then Mouseover in RFQ Numner TCC

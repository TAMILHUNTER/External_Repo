...
public class BaseClass extends ConfigFileReader {
	...
	public static void SelectListText(List<WebElement> ele, String text) {
		se = new Select((WebElement) ele);
		se.selectByVisibleText(text);
	}
...
//	gopal
	public static void getlistOption(List<WebElement> ele) {
		se = new Select((WebElement) ele);
		List<WebElement> options = se.getOptions();
		System.out.println("Number of Options :" + options.size());
		for (int i = 0; i < options.size(); i++) {
	...
	public static void ClickUsingTryCatch(WebElement ele) throws InterruptedException {
	...
	public static void ClickUsingJSTryCatch(WebElement ele) throws InterruptedException {
	...
	public static void ScrollUsingJaveScript(WebElement ele) throws InterruptedException {

		Thread.sleep(1000);
		((JavascriptExecutor) Webdriver.driver).executeScript("arguments[0].scrollIntoView(true);", ele);
	 
        
	}
	
	public static void ClearUsingTryCatch(WebElement ele) throws InterruptedException {
	
	Thread.sleep(500);

	try {
		j.executeScript("arguments[0].value = '';", ele);

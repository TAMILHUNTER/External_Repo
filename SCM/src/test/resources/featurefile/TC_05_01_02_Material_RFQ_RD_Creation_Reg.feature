@RFQRateDiscoveryMaterialRegressionPart1
Feature: Regression for RFQ Creation

  Background: 
    Given Go to Test Environment

  Scenario: Domestic Job Material Rate Discovery RFQ Create Regression
  ...
  Scenario: Domestic Job Material Rate Discovery RFQ Create Using Other cost Percentage Regression
    Then Click on Other User
    Then Enter EIP QA Username
    Then Enter the Password
    Then Click on Login

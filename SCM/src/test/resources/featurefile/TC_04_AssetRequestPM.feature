...
Feature: Asset Request
 ...
 Scenario Outline: Asset Request Creation
    ...
    Examples: 
      ...
      | AVJ      | Asset Request | Buildings & Factories | LE180046 |        2699 |         0176 | 0C56M0001000000 |         10 |                 10 |             100 |
  ...
  Scenario Outline: Asset Request Authorization Final Level
    ...
    Examples: 
      ...
      | PRCPRS       | Approved Asset Request | aruls     |
       ...
       Scenario: Capital PM RFQ Creation
  ...
  Scenario Outline: Domestic Job Capital RFQ PM BQ
  ...
  Scenario Outline: Capital RFQ PM Page
  ...
  Scenario Outline: Capital RFQ PM TCD Page

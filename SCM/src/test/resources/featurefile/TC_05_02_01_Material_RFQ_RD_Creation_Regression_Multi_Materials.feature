@RFQRateDiscoveryMultiMaterialRegressionPart1
Feature: Regression for RFQ Creation
  ...
  Scenario: Domestic Job Multi Material Rate Discovery RFQ Create Regression
  ...
  Scenario: Edit Domestic Job Material Rate Discovery RFQ Create Regression
    Then Click on Other User
    Then Enter EIP QA Username
    Then Enter the Password
    Then Click on Login
    ...
    And Edit Sugg Rate in RFQ Create Page
    And Request For Quote Choose Vendors Page Verification
  ...
  Scenario: Domestic Job Material Rate Discovery RFQ Auto BQ  Create Regression
    Then Click on Other User
    Then Enter EIP QA Username
    Then Enter the Password
    Then Click on Login
  ...
  Scenario: Domestic Job Multi Material Rate Discovery RFQ Create Using Other cost Percentage Regression
    Then Click on Other User
    Then Enter EIP QA Username
    Then Enter the Password
    Then Click on Login
  ...
  Scenario: Edit Domestic Job Material Rate Discovery RFQ Create Using Other cost Percentage Regression
    Then Click on Other User
    Then Enter EIP QA Username
    Then Enter the Password
    Then Click on Login
  ...
  Scenario: Material TCC Page Other cost Percentage Regression
    Then Request For Quote Login for TCC
    Then Select Filter icon
    And Enter Domestic Job RFQ No from DB TCC
    Then Mouseover in RFQ Numner TCC
  ...
  Scenario: Domestic Job Material Rate Discovery RFQ Create Using Other cost Lumpsum Regression
    Then Click on Other User
    Then Enter EIP QA Username
    Then Enter the Password
    Then Click on Login
  ...
  Scenario: Edit Domestic Job Material Rate Discovery RFQ Create Using Other cost Lumpsum Regression
    Then Click on Other User
    Then Enter EIP QA Username
    Then Enter the Password
    Then Click on Login
  ...
  Scenario: Domestic Job RD RFQ Other cost Lumpsum BQ Regression
    Then RFQ Bidders Quote Login
    Then Select Show Advance Search
    Then Enter Domestic Job RFQ No from DB
    Then Select Search icon in Bidders Quote

...
Feature: Browser_Compatibility
  ...
  ************************************************
  ...
  @Induction_Create_Basic_Details_Partner_Browser
  Scenario: Partner
...
@Induction_Create_Basic_Details_Personal_Browser
  Scenario: Personal
...
@Induction_Create_Basic_Details_Communication_Browser
...
@Induction_Create_Basic_Details_Skill_Browser
  Scenario: Skill
...
@Induction_Create_Basic_Details_Deployment_Browser
  Scenario: Deployment
...
@Induction_Create_Basic_Details_Education_Browser
  Scenario: Education
...
@Induction_Create_Basic_Details_Experience_Browser
  Scenario: Experience
...
@Induction_Create_Basic_Details_Statutory_Browser
  Scenario: Statutory
...
@Induction_Create_Basic_Details_Bank_Browser
  Scenario: Bank
...
@Induction_Create_Basic_Details_Submit_workman_details_Browser

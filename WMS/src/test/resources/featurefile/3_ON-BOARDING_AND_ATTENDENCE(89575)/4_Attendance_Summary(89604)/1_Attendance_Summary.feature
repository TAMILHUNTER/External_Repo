@Attendance_Summery
Feature: Feature : On-Boarding & Attendance (89575) UserStory: Attendance_Summery(89604)
  **********************************************************************************************
  UserStory: Attendance_Summery(89604)
  *********************************************
  Description : As a EIP User i should be able to View Attendance Summery
  ***************************************************************************************************************************************

  @Attendance_Summery_View
  Scenario: Verify user can be able to View Attendance Summary
    ...
    @Attendance_Summery_View_Search

...
//***********************************************************************************************************************//
	...
	public static String getJob_LE20D146() {
		String Job_LE20D146 = properties.getProperty("Job_LE20D146");
		if (Job_LE20D146 != null)
			return Job_LE20D146;
		else
			throw new RuntimeException("Job_LE20D146 not specified in the Configuration.properties file.");
	}
	...
	public static String getSwitch_international_job_LE20D146() {
		String Switch_international_job_LE20D146 = properties.getProperty("Switch_international_job_LE20D146");
		if (Switch_international_job_LE20D146 != null)
			return Switch_international_job_LE20D146;
		else
			throw new RuntimeException("Switch_international_job_LE20D146 not specified in the Configuration.properties file.");
	}
...
//Login Test-Data-RoleBase-Separate-Login
	...
	public static String getInduction_Creator_username_nepal() {
		String Induction_Creator_username_nepal = properties.getProperty("Induction_Creator_username_nepal");
		if (Induction_Creator_username_nepal != null)
			return Induction_Creator_username_nepal;
		else
	...
	public static String getInduction_Creator_password_nepal() {
		...
		if (Induction_Creator_password_nepal != null)
			return Induction_Creator_password_nepal;
		else
			throw new RuntimeException("Induction_Creator_password_nepal not specified in the Configuration.properties file.");
	}
	...
	public static String getcolorsofeyes() {
		String colorsofeyes = properties.getProperty("colorsofeyes");
		if (colorsofeyes != null)
			return colorsofeyes;
		else
			throw new RuntimeException("colorsofeyes not specified in the Configuration.properties file.");
	}
	public static String getcomplexion() {
		String complexion = properties.getProperty("complexion");
		if (complexion != null)
			return complexion;
		else
			throw new RuntimeException("complexion not specified in the Configuration.properties file.");
	}
...
//*************
	...
	public static String getSearch_By_Name_value() {
		String Search_By_Name_value = properties.getProperty("Search_By_Name_value");
		if (Search_By_Name_value != null)
			return Search_By_Name_value;
		else
			throw new RuntimeException("Search_By_Name_value not specified in the Configuration.properties file.");
	}

	public static String getSearch_By_FatherName_value() {
		String Search_By_FatherName_value = properties.getProperty("Search_By_FatherName_value");
		if (Search_By_FatherName_value != null)
			return Search_By_FatherName_value;
		else
			throw new RuntimeException("Search_By_FatherName_value not specified in the Configuration.properties file.");
	}
...
//#######################################################Communication######################################################################################
	...
	public static String getselectPartner_Value() {
		String selectPartner_Value = properties.getProperty("selectPartner_Value");
		if (selectPartner_Value != null)
			return selectPartner_Value;
		else
			throw new RuntimeException("selectPartner_Value not specified in the Configuration.properties file.");
	}
	public static String getselectWorktype_Value() {
		String selectWorktype_Value = properties.getProperty("selectWorktype_Value");
		if (selectWorktype_Value != null)
			return selectWorktype_Value;
		else
			throw new RuntimeException("selectWorktype not specified in the Configuration.properties file.");
	}
	public static String getselect_Language_Value() {
		String select_Language_Value = properties.getProperty("select_Language_Value");
		if (select_Language_Value != null)
			return select_Language_Value;
		else
			throw new RuntimeException("select_Language_Value not specified in the Configuration.properties file.");
	}
	public static String getselect_Gender_Value() {
		String select_Gender_Value = properties.getProperty("select_Gender_Value");
		if (select_Gender_Value != null)
			return select_Gender_Value;
		else
			throw new RuntimeException("select_Gender_Value not specified in the Configuration.properties file.");
	}
	public static String getselect_BloodGroup_Value() {
		String select_BloodGroup_Value = properties.getProperty("select_BloodGroup_Value");
		if (select_BloodGroup_Value != null)
			return select_BloodGroup_Value;
		else
			throw new RuntimeException("select_BloodGroup_Value not specified in the Configuration.properties file.");
	}
	public static String getselect_Marital_Value() {
		String select_Marital_Value = properties.getProperty("select_Marital_Value");
		if (select_Marital_Value != null)
			return select_Marital_Value;
		else
			throw new RuntimeException("select_Marital_Value not specified in the Configuration.properties file.");
	}
	public static String getselect_EC_Relation_Value() {
		String select_EC_Relation_Value = properties.getProperty("select_EC_Relation_Value");
		if (select_EC_Relation_Value != null)
			return select_EC_Relation_Value;
		else
			throw new RuntimeException("select_EC_Relation_Value not specified in the Configuration.properties file.");
	}
	public static String getselect_skillCategory_Value() {
		String getselect_skillCategory_Value = properties.getProperty("getselect_skillCategory_Value");
		if (getselect_skillCategory_Value != null)
			return getselect_skillCategory_Value;
		else
			throw new RuntimeException("getselect_skillCategory_Value not specified in the Configuration.properties file.");
	}
	public static String getselect_skillGroup_Value() {
		String getselect_skillGroup_Value = properties.getProperty("getselect_skillGroup_Value");
		if (getselect_skillGroup_Value != null)
			return getselect_skillGroup_Value;
		else
			throw new RuntimeException("getselect_skillCategory_Value not specified in the Configuration.properties file.");
	}
	public static String getselect_skillDescription_Value() {
		String getselect_skillDescription_Value = properties.getProperty("getselect_skillDescription_Value");
		if (getselect_skillDescription_Value != null)
			return getselect_skillDescription_Value;
		else
			throw new RuntimeException("getselect_skillCategory_Value not specified in the Configuration.properties file.");
	}
	public static String getselect_skillType_Value() {
		String getselect_skillType_Value = properties.getProperty("getselect_skillType_Value");
		if (getselect_skillType_Value != null)
			return getselect_skillType_Value;
		else
			throw new RuntimeException("getselect_skillType_Value not specified in the Configuration.properties file.");
	}
	public static String getExperience_Skill_values() {
		String Experience_Skill_values = properties.getProperty("Experience_Skill_values");
		if (Experience_Skill_values != null)
			return Experience_Skill_values;
		else
			throw new RuntimeException("Experience_Skill_values not specified in the Configuration.properties file.");
	}
	
	public static String getPF_Nominee_Relation_values() {
		String PF_Nominee_Relation_values = properties.getProperty("PF_Nominee_Relation_values");
		if (PF_Nominee_Relation_values != null)
			return PF_Nominee_Relation_values;
		else
			throw new RuntimeException("PF_Nominee_Relation_values not specified in the Configuration.properties file.");
	}
	
	public static String getUpload_Statutory_File_pdf() {
		String Upload_Statutory_File_pdf = properties.getProperty("Upload_Statutory_File_pdf");
		if (Upload_Statutory_File_pdf != null)
			return Upload_Statutory_File_pdf;
		else
			throw new RuntimeException("Upload_Statutory_File_pdf not specified in the Configuration.properties file.");
	}
	public static String getUpload_Statutory_File_Excel() {
		String Upload_Statutory_File_Excel = properties.getProperty("Upload_Statutory_File_Excel");
		if (Upload_Statutory_File_Excel != null)
			return Upload_Statutory_File_Excel;
		else
			throw new RuntimeException("Upload_Statutory_File_Excel not specified in the Configuration.properties file.");
	}
	
	public static String getUpload_Statutory_File_JPEG() {
		String Upload_Statutory_File_JPEG = properties.getProperty("Upload_Statutory_File_JPEG");
		if (Upload_Statutory_File_JPEG != null)
			return Upload_Statutory_File_JPEG;
		else
			throw new RuntimeException("Upload_Statutory_File_JPEG not specified in the Configuration.properties file.");
	}
	
	public static String getUpload_Statutory_File_TXT() {
		String Upload_Statutory_File_TXT = properties.getProperty("Upload_Statutory_File_TXT");
		if (Upload_Statutory_File_TXT != null)
			return Upload_Statutory_File_TXT;
		else
			throw new RuntimeException("Upload_Statutory_File_TXT not specified in the Configuration.properties file.");
	}
	
	public static String getUpload_Doc_type() {
		String Upload_Doc_type = properties.getProperty("Upload_Doc_type");
		if (Upload_Doc_type != null)
			return Upload_Doc_type;
		else
			throw new RuntimeException("Upload_Doc_type not specified in the Configuration.properties file.");
	}
	...
	public static String getAttachmenttype() {
		...
		if (Attachmenttype != null)
			...
			throw new RuntimeException("Attachmenttype not specified in the Configuration.properties file.");
	}
	
	public static String getAttachment_isExternal() {
		String Attachment_isExternal = properties.getProperty("Attachment_isExternal");
		if (Attachment_isExternal != null)
			return Attachment_isExternal;
		else
			throw new RuntimeException("Attachment_isExternal not specified in the Configuration.properties file.");
	}
	
	public static String getnearestpolicestation() {
		String nearestpolicestation = properties.getProperty("nearestpolicestation");
		if (nearestpolicestation != null)
			return nearestpolicestation;
		else
			throw new RuntimeException("nearestpolicestation not specified in the Configuration.properties file.");
	}
